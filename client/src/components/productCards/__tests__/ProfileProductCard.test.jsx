...
it('renders correctly when the value is not provided', () => {
    ...
    const { getByText, queryByRole, queryByText } = render(
        <ProfileProductCard productName={productName} image={ProfileImage} productId={productId} />
    );
...
it('renders correctly when name is not provided', () => {
    ...
    const { getByText, queryByRole, queryByText } = render(
        <ProfileProductCard value={value} image={ProfileImage} productId={productId} />
    );
...
it('renders correctly when the image is not provided', () => {
    ...
    const { getByText, queryByRole } = render(
        <ProfileProductCard value={value} productName={productName} productId={productId} />
    );
...
it('renders correctly when all inputs are provided', () => {
    ...
    const { getByText, queryByRole } = render(
        <ProfileProductCard value={value} productName={productName} image={ProfileImage} productId={productId} />
    );
