...
const PrivateRoomCreationForm = () => {
  ...
  return (
    <Box>
      ...
      <Box sx={{mb: 4}}>
        <InputLabel sx={{color: "white", fontSize: "18px"}}>Room Name</InputLabel>
        <TextField
          value={roomName}
      ...
      <Box sx={{mb: 4, display: "flex", alignItems: "center"}}>
        <FormControlLabel
          control={
            <Checkbox
              ...
              sx={{ '& .MuiSvgIcon-root': { fontSize: "18px", color: "white" } }}
        ...
        />
        <Tooltip title={"Enabling this will allow your friends to see your private room from your profile"}>
          <HelpOutlineIcon
            sx={{
              fontSize: "25px",
              color: "white"
